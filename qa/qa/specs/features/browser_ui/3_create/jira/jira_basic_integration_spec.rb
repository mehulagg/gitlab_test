  ...
  context 'Create' do
    ...
    describe 'Jira integration', :jira, :orchestrated, :requires_admin do
      ...
      before(:all) do
        ...
        # Retry is required because enabling allow_local_requests_from_web_hooks_and_services
        # takes some time to get enabled. Bug issue: https://gitlab.com/gitlab-org/gitlab/-/issues/217010
