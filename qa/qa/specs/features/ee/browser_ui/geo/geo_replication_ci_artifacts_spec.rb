...
module QA
  RSpec.describe 'Geo', :orchestrated, :runner, :requires_admin, :geo do
    describe 'CI job artifact' do
      ...
      it 'replicates to the secondary Geo site', testcase: 'https://gitlab.com/gitlab-org/quality/testcases/-/issues/186' do
        ...
        QA::Flow::Login.while_signed_in(address: :geo_secondary) do
          ...
          Page::Project::Job::Show.perform do |pipeline_job|
            expect(pipeline_job).to have_browse_button
