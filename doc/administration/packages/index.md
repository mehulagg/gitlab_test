...
| [NPM Repository](../../user/packages/npm_registry/index.md)   | The GitLab NPM Repository enables every project in GitLab to have its own space to store [NPM](https://www.npmjs.com/) packages. | 11.7+ |
