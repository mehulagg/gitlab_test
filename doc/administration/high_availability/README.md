...
your environment makeup. Here we'll detail both in the order in which
you would typically configure them along with our recommendations for
their use and configuration.

**Services (Third Party)**

First we detail several third party services a typical environment
...
These should be configured first before the GitLab components:
...
Next are all of the components we provide directly. As mentioned
