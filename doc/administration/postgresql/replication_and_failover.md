...
replica node. These parameters are usually detected from the existing database. However it does
not work on Patroni replicas and you will need to use environment variables.
