...
This command must be run from your app server and will not work correctly on component servers like [Gitaly](https://docs.gitlab.com/ee/administration/gitaly/#running-gitaly-on-its-own-server).
