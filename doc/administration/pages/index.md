...
Pages runs inside a chroot jail; usually in a uniquely numbered directory that
matches `/tmp/gitlab-pages-*`
...
The use of a chroot jail makes this error confusing, as it is not
