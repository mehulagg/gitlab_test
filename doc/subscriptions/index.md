...
GitLab.com subscriptions can be upgraded:

- Directly through the [Subscriptions portal](https://customers.gitlab.com/subscriptions)
- By clicking on **Upgrade** within a group **Settings > Billing** menu
