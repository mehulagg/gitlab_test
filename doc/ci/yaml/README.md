...
| `pipelines`      | For multi-project triggers using a [bridge job](../multi_project_pipelines.md#triggering-a-downstream-pipeline-using-a-bridge-job) or created using the API with `CI_JOB_TOKEN`. |
