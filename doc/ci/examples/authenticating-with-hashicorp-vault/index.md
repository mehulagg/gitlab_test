...
- A running Vault server and the access required to configure authentication and create roles and policies.  This can be the Open Source or Enterprise version of Vault.
