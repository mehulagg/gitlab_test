...
- A running Vault server and access to it is required in order to configure authentication and create roles and policies. For HashiCorp Vaults, this can be the Open Source or Enterprise version.
