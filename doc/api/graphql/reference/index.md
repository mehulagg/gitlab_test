...
| Name  | Type  | Description |
| ---   |  ---- | ----------  |
| `date` | String! | Date of the DailyBuildGroupReportResult |
| `groupName` | String! | Group name of the DailyBuildGroupReportResult |
| `id` | ID! | ID of the DailyBuildGroupReportResult |
...
| `codeCoverage` | DailyBuildGroupReportResult | The code coverage of the project |
