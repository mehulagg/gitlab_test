...
| `userPreferences` | EpicUserPreferences | User preferences for the epic on the issue board |
...
| Field | Type | Description |
| ----- | ---- | ----------- |
| `collapsed` | Boolean! | Whether epic should be collapsed |
...
| ----- | ---- | ----------- |
| `clientMutationId` | String | A unique identifier for the client performing the mutation. |
| `epicUserPreferences` | EpicUserPreferences | The board epic user preferences after mutation. |
| `errors` | String! => Array | Errors encountered during execution of the mutation. |
