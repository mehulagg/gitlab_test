...
| Name  | Type  | Description |
| ---   |  ---- | ----------  |
| `licenses` | License! => Array | Licenses associated with a dependency |
| `location` | String | Location of a dependency in a project |
| `name` | String | Name of a dependency |
| `packager` | String | Package manager of a dependency |
| `version` | String | Version of a dependency |
| `vulnerabilities` | Vulnerability! => Array | Vulnerabilities associated with a dependency |
...
| `name` | String | Name of a license |
| `url` | String | Path of a license |
...
| `dependencies` | Dependency! => Array | Components used by the project |
...
| `licenses` | License! => Array | Licenses used by the project |
...
| Name  | Type  | Description |
| ---   |  ---- | ----------  |
| `name` | String | Name of a vulnerability |
| `severity` | String | Severity of a vulnerability |
