...
Represents a the daily code coverage for a project

| Name  | Type  | Description |
| ---   |  ---- | ----------  |
| `coverage` | Float | Percent of coverage for the project |
| `coverageCount` | Int | Number of coverage for the project |
| `lastUpdate` | String | Latest date of coverage for the project |
...
| `codeCoverage` | CodeCoverage | The code coverage of the project. Available only when feature flag `code_coverage_graphql` is enabled |
