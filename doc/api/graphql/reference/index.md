...
Represents the daily code coverage for a project

| Name  | Type  | Description |
| ---   |  ---- | ----------  |
| `average` | Float | Percentage of coverage for the project |
| `count` | Int | Number of coverage for the project |
| `lastUpdateAt` | Time | Latest date of coverage for the project |
