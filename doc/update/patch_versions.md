...
Make sure you view [this update guide](https://gitlab.com/gitlab-org/gitlab-foss/blob/master/doc/update/patch_versions.md) from the tag (version) of GitLab you would like to install.
