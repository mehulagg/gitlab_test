...
| `db/` | `spec/db/` | RSpec | |
| `db/{post_,}migrate/` | `spec/migrations/` | RSpec | More details at [`spec/migrations/README.md`](https://gitlab.com/gitlab-org/gitlab-foss/blob/master/spec/migrations/README.md). |
...
[test plan]: https://gitlab.com/gitlab-org/gitlab-foss/tree/master/.gitlab/issue_templates/Test%20plan.md
