...
Please submit bugs using the ['Bug' issue template](https://gitlab.com/gitlab-org/gitlab-foss/blob/master/.gitlab/issue_templates/Bug.md) provided on the issue tracker.
...
Please submit Feature Proposals using the ['Feature Proposal' issue template](https://gitlab.com/gitlab-org/gitlab-foss/blob/master/.gitlab/issue_templates/Feature%20proposal.md) provided on the issue tracker.
