...
The GitLab Omnibus package can be used to configure a standalone Monitoring node running [Prometheus](../../administration/monitoring/prometheus/index.md) and [Grafana](../../administration/monitoring/performance/grafana_configuration.md).
The monitoring node is not highly available. See our [System Architecture](index.md)
