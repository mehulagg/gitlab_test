...
`pgbouncer` and connect to the database direct](../administration/postgresql/pgbouncer.md#procedure-for-bypassing-pgbouncer).
...
[connect direct to the primary database node](../administration/postgresql/pgbouncer.md#procedure-for-bypassing-pgbouncer)
