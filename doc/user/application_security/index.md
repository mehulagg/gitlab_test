...
To ensure the DAST scanner runs *after* deploying the application to the staging server, review the [DAST full documentation](dast/).

To add Container Scanning follow the steps listed in the [Container Scanning documentation](container_scanning/#requirements).
