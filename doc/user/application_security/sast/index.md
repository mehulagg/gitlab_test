...
Please work with your IT staff to get temporary access to download these resources, or establish alternate ways (external drives, network shares, etc) you can bring these resources in.

You need the below inside your instance and acessible across the instance (for example as part of a Local Area Network).
