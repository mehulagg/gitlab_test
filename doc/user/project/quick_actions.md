...
| `/zoom <Zoom URL>`                    | ✓     |               |      | Add Zoom meeting to this issue. ([Introduced in GitLab 12.3](https://gitlab.com/gitlab-org/gitlab/merge_requests/16609). Must be enabled by a [feature flag](../../administration/feature_flags.md#issue_zoom_integration) for self-hosted. |
| `/remove_zoom`                        | ✓     |               |      | Remove Zoom meeting from this issue. ([Introduced in GitLab 12.3](https://gitlab.com/gitlab-org/gitlab/merge_requests/16609). Must be enabled by a [feature flag](../../administration/feature_flags.md#issue_zoom_integration) for self-hosted. |
