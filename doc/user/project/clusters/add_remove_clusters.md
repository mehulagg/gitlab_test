...
To add an existing Kubernetes cluster to your project, group, or instance:
...
1. Click the **Add existing cluster** tab and fill in the details:
   ...
   1. **Project namespace** (optional) - You don't have to fill it in; by leaving
     ...
     1. Each project should have a unique namespace.
     1. The project namespace is not necessarily the namespace of the secret, if
       you're using a secret with broader permissions, like the secret from `default`.
     1. You should **not** use `default` as the project namespace.
     1. If you or someone created a secret specifically for the project, usually
