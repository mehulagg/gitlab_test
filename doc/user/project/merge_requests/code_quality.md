...
> [Available](https://gitlab.com/gitlab-org/gitlab/-/merge_requests/36120) in [GitLab Core](https://about.gitlab.com/pricing/) as of 13.2.
...
- The full list of code quality violations generated by a pipeline is shown in the
  Code Quality tab of the Pipeline Details page. (available in
  [GitLab Starter](https://about.gitlab.com/pricing/) and above)
