...
- Add `[Draft]`, `Draft:`, <code>Draft - </code> or `(Draft)` to the start of the merge request's title. Clicking on
...
- Remove `[Draft]`, `Draft:`, <code>Draft - </code> or `(Draft)` from the start of the merge request's title. Clicking on
