...
> [Introduced](https://gitlab.com/gitlab-org/gitlab/issues/18954) in GitLab 12.4 **(CORE ONLY)** (Self-managed).
> NOTE: **Note:**
This feature is disabled by default. To enable it, have a GitLab admin enable the following [feature flag](../../development/feature_flags/development.md#enabling-a-feature-flag-in-development): `multi_select_board`.
