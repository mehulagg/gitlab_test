...
It should be noted that the GitLab UI behavior with Bamboo will be limited to features that work with GitLab. 
Some features that Bamboo customers use with their other Atlassian developer tools will not work with GitLab. 
