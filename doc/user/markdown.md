...
NOTE: **Note:** We encourage you to view this document as [rendered by GitLab itself](https://gitlab.com/gitlab-org/gitlab-foss/blob/master/doc/user/markdown.md).
...
> If this is not rendered correctly, [view it in GitLab itself](https://gitlab.com/gitlab-org/gitlab-foss/blob/master/doc/user/markdown.md#colors).
...
> If this is not rendered correctly, [view it in GitLab itself](https://gitlab.com/gitlab-org/gitlab-foss/blob/master/doc/user/markdown.md#emoji).
...
you can toggle between the source and rendered version of a [GitLab documentation file](https://gitlab.com/gitlab-org/gitlab-foss/blob/master/doc/README.md).
...
> If this is not rendered correctly, [view it in GitLab itself](https://gitlab.com/gitlab-org/gitlab-foss/blob/master/doc/user/markdown.md#inline-diff).
...
> If this is not rendered correctly, [view it in GitLab itself](https://gitlab.com/gitlab-org/gitlab-foss/blob/master/doc/user/markdown.md#math).
...
> If this is not rendered correctly, [view it in GitLab itself](https://gitlab.com/gitlab-org/gitlab-foss/blob/master/doc/user/markdown.md#task-lists).
...
> If this is not rendered correctly, [view it in GitLab itself](https://gitlab.com/gitlab-org/gitlab-foss/blob/master/doc/user/markdown.md#multiline-blockquote).
...
> If this is not rendered correctly, [view it in GitLab itself](https://gitlab.com/gitlab-org/gitlab-foss/blob/master/doc/user/markdown.md#colored-code-and-syntax-highlighting).
...
> If this is not rendered correctly, [view it in GitLab itself](https://gitlab.com/gitlab-org/gitlab-foss/blob/master/doc/user/markdown.md#multiple-underscores-in-words).
...
> If this is not rendered correctly, [view it in GitLab itself](https://gitlab.com/gitlab-org/gitlab-foss/blob/master/doc/user/markdown.md#videos).
...
> To see the markdown rendered within HTML in the second example, [view it in GitLab itself](https://gitlab.com/gitlab-org/gitlab-foss/blob/master/doc/user/markdown.md#inline-html).
...
> To see the markdown rendered within HTML in the second example, [view it in GitLab itself](https://gitlab.com/gitlab-org/gitlab-foss/blob/master/doc/user/markdown.md#details-and-summary).
...
> Note that the headers are always right aligned [within GitLab itself](https://gitlab.com/gitlab-org/gitlab-foss/blob/master/doc/user/markdown.md#tables).
