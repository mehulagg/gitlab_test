...
| View [metrics dashboard annotations](project/integrations/prometheus.md#dashboard-annotations) |          | ✓          | ✓           | ✓        | ✓      |
| Manage [metrics dashboard annotations](project/integrations/prometheus.md#dashboard-annotations) |          |          | ✓           | ✓        | ✓      |
