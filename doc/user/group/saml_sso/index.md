...
An error message is expected in the case where a user account with the email address already exists in GitLab, but the user does not have the SAML identity tied to their account. The user will need to [link their account](#user-access-and-management).
