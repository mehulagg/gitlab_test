...
NOTE: **Note:**
Shared Runners provided by GitLab are **not** configureable. Consider [installing your own Runner](https://docs.gitlab.com/runner/install/) if specific configurations are needed.
