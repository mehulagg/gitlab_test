...
can be used for a variety of activities, such as seeding the build
directory with repository data, sending a request to a server,
downloading assets from a CDN, etc.
