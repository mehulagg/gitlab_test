...
1. In Gitlab, navigate to your project’s **Operations > Error Tracking** and click **Enable Error Tracking**.
1. Then, navigate to your project’s **Settings > Operations** and ensure that the **Active** checkbox is set under Error Tracking section.
