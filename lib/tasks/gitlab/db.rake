namespace :gitlab do
  namespace :db do
    ...
    desc 'This adjusts and cleans db/structure.sql - it should run after db:structure:dump'
    task :fix_structure_sql do
    ...
    Rake::Task['db:structure:dump'].enhance do
      Rake::Task['gitlab:db:fix_structure_sql'].invoke
    end
  end
end
