      ...
      module Conan
        module ApiHelpers
          ...
          def download_package_file(file_type)
            ...
            package_event('pull_package', :conan, category: 'API::ConanPackages') if params[:file_name] == ::Packages::Conan::FileMetadatum::PACKAGE_BINARY
          ...
          def track_push_package_event
            if params[:file_name] == ::Packages::Conan::FileMetadatum::PACKAGE_BINARY && params[:file].size > 0 # rubocop: disable Style/ZeroLengthPredicate
              package_event('push_package', :conan, category: 'API::ConanPackages')
            end
          end
