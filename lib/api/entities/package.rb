...
module API
  module Entities
    class Package < Grape::Entity
      ...
      expose :id
      expose :name, unless: ->(package) { package.package_type == 'conan' }
      expose :conan_recipe, as: :name, if: ->(package) { package.package_type == 'conan' }
      expose :name, as: :conan_package_name, if: ->(package) { package.package_type == 'conan' }
      expose :version
      expose :package_type
