  ...
  module Analytics
    module ValueStreamAnalytics
      class RecordsFetcher
        ...
        include Gitlab::ValueStreamAnalytics::MetricsTables
        ...
        def default_test_stage?
          stage.matches_with_stage_params?(Gitlab::Analytics::ValueStreamAnalytics::DefaultStages.params_for_test_stage)
        end

        def default_staging_stage?
          stage.matches_with_stage_params?(Gitlab::Analytics::ValueStreamAnalytics::DefaultStages.params_for_staging_stage)
        end
        ...
        def ci_build_records
          ...
          Gitlab::ValueStreamAnalytics::Updater.update!(results, from: 'id', to: 'build', klass: ::Ci::Build.includes({ project: [:namespace], user: [], pipeline: [] }))
        end
...
Gitlab::Analytics::ValueStreamAnalytics::RecordsFetcher.prepend_if_ee('EE::Gitlab::Analytics::ValueStreamAnalytics::RecordsFetcher')
