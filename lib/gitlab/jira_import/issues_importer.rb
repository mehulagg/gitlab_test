      ...
      def schedule_issue_import_workers(issues)
        ...
        issues.each do |jira_issue|
          ...
          begin
            ...
            # handle any serialization exceptionn here and skip importing the failed to serialize issue, instead of
            # failing to import the entire batch of issues

            # track the failed to import issue, mot probably because of the serialization problem.
