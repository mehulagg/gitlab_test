...
class Repositories::GitHttpController < Repositories::GitHttpClientController
  ...
  def access
    @access ||= access_klass.new(access_actor, @repositorable, 'http',
  ...
  def access_check
    ...
    unless @repositorable
      @project = @repositorable = access.project
    end
  end
