  ...
  module Import
    module StuckImportJob
      ...
      def perform
        ...
        track_metrics(import_state_with_jid_count, import_state_without_jid_count)
      end
      ...
      def mark_import_states_with_jid_as_failed!
        ...
        Gitlab::AppLogger.info("Marked stuck import jobs as failed. JIDs: #{completed_import_state_jids}")
