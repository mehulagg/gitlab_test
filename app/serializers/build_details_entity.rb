...
class BuildDetailsEntity < JobEntity
  ...
  expose :deployment_cluster, if: -> (build) { build&.deployment&.deployment_cluster } do |build, options|
    DeploymentClusterEntity.represent(build.deployment.deployment_cluster, options)
  end
