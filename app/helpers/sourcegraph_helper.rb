...
module SourcegraphHelper
  ...
  def sourcegraph_experimental_message
    if Gitlab::Sourcegraph.feature_conditional?
      s_("SourcegraphPreferences|This feature is experimental and currently limited to only certain projects.")
    elsif Gitlab::CurrentSettings.sourcegraph_public_only
      s_("SourcegraphPreferences|This feature is experimental and limited to only public projects.")
    else
