...
module Ci
  class CreatePipelineService < BaseService
    ...
    def execute(source, ignore_skip_ci: false, save_config_errors: true, trigger_request: nil, schedule: nil, merge_request: nil, external_pull_request: nil, bridge: nil, **options, &block)
      ...
      command = Gitlab::Ci::Pipeline::Chain::Command.new(
        ...
        save_incompleted: save_config_errors,
        seeds_block: block,
