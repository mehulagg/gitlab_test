...
export default {
  ...
  computed: {
    ...
    roleDropdownHelpPath() {
      return 'https://docs.aws.amazon.com/eks/latest/userguide/service_IAM_role.html#create-service-role';
    },
    regionsDropdownHelpText() {
      return s__('ClusterIntegration|Learn more about %{linkStart}Regions%{linkEnd}.');
    },
    regionsDropdownHelpPath() {
      return 'https://aws.amazon.com/about-aws/global-infrastructure/regional-product-services/';
    },
    ...
    keyPairDropdownHelpPath() {
      return 'https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-key-pairs.html#having-ec2-create-your-key-pair';
    },
    vpcDropdownHelpText() {
      return s__(
    ...
    vpcDropdownHelpPath() {
      return 'https://docs.aws.amazon.com/eks/latest/userguide/getting-started-console.html#vpc-create';
    },
    ...
    subnetDropdownHelpPath() {
      return 'https://console.aws.amazon.com/vpc/home?#subnets';
    },
    ...
    securityGroupDropdownHelpPath() {
      return 'https://console.aws.amazon.com/vpc/home?#securityGroups';
    },
    instanceTypesDropdownHelpText() {
      return s__('ClusterIntegration|Choose the worker node %{linkStart}instance type%{linkEnd}.');
    },
    instanceTypesDropdownHelpPath() {
      return 'https://aws.amazon.com/ec2/instance-types';
    },
    gitlabManagedClusterHelpText() {
      return s__(
...
<template>
  <form name="eks-cluster-configuration-form">
    ...
    <div class="mb-3">
      <gl-sprintf :message="kubernetesIntegrationHelpText">
    ...
    <div class="form-group">
      ...
      <p class="form-text text-muted">
        <gl-sprintf :message="roleDropdownHelpText">
          <template #link="{ content }">
            <gl-link :href="roleDropdownHelpPath" target="_blank" rel="noopener noreferrer">
              {{ content }}
    ...
    <div class="form-group">
      ...
      />
      <p class="form-text text-muted">
        <gl-sprintf :message="regionsDropdownHelpText">
          <template #link="{ content }">
            <gl-link :href="regionsDropdownHelpPath" target="_blank" rel="noopener noreferrer">
              {{ content }}
              <gl-icon name="external-link" class="vertical-align-middle" />
            </gl-link>
          </template>
    ...
    <div class="form-group">
      ...
      />
      <p class="form-text text-muted">
        <gl-sprintf :message="keyPairDropdownHelpText">
          <template #link="{ content }">
            <gl-link :href="keyPairDropdownHelpPath" target="_blank" rel="noopener noreferrer">
              {{ content }}
              <gl-icon name="external-link" class="vertical-align-middle" />
            </gl-link>
          </template>
    ...
    <div class="form-group">
      ...
      />
      <p class="form-text text-muted">
        <gl-sprintf :message="vpcDropdownHelpText">
          <template #link="{ content }">
            <gl-link :href="vpcDropdownHelpPath" target="_blank" rel="noopener noreferrer">
              {{ content }}
              <gl-icon name="external-link" class="vertical-align-middle" />
            </gl-link>
          </template>
    ...
    <div class="form-group">
      ...
      />
      <p class="form-text text-muted">
        <gl-sprintf :message="subnetDropdownHelpText">
          <template #link="{ content }">
            <gl-link :href="subnetDropdownHelpPath" target="_blank" rel="noopener noreferrer">
              {{ content }}
              <gl-icon name="external-link" class="vertical-align-middle" />
            </gl-link>
          </template>
    ...
    <div class="form-group">
      ...
      />
      <p class="form-text text-muted">
        <gl-sprintf :message="securityGroupDropdownHelpText">
          <template #link="{ content }">
            <gl-link
              :href="securityGroupDropdownHelpPath"
              target="_blank"
    ...
    <div class="form-group">
      ...
      />
      <p class="form-text text-muted">
        <gl-sprintf :message="instanceTypesDropdownHelpText">
          <template #link="{ content }">
            <gl-link
              :href="instanceTypesDropdownHelpPath"
              target="_blank"
              rel="noopener noreferrer"
            >
              {{ content }}
    ...
    <div class="form-group">
      ...
      >
      <p class="form text text-muted">
        <gl-sprintf :message="gitlabManagedClusterHelpText">
          <template #link="{ content }">
            <gl-link :href="gitlabManagedClusterHelpPath" target="_blank" rel="noopener noreferrer">
              {{ content }}
            </gl-link>
          </template>
        </gl-sprintf>
    ...
    <div class="form-group">
      ...
      >
      <p class="form text text-muted">
        <gl-sprintf :message="namespacePerEnvironmentHelpText">
          <template #link="{ content }">
            <gl-link
              :href="namespacePerEnvironmentHelpPath"
              target="_blank"
              rel="noopener noreferrer"
            >
              {{ content }}
