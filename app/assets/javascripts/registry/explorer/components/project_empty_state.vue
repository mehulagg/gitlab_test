  ...
  computed: {
    ...
    notLoggedInToRegistryText() {
      return sprintf(
        ...
        {
          twofaDocLinkStart: `<a href="${this.config.twoFactorAuthHelpLink}" target="_blank">`,
          twofaDocLinkEnd: '</a>',
          personalAccessTokensDocLinkStart: `<a href="${this.config.personalAccessTokensHelpLink}" target="_blank">`,
