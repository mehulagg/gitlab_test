...
export const FILTER_QUERIES_WITH_ALERTS = 'FILTER_QUERIES_WITH_ALERTS';
export const SET_LOADING = 'SET_LOADING';
export const SET_ALERTS_ENDPOINT = 'SET_ALERTS_ENDPOINT';
export const UPDATE_FORM_ALERT = 'UPDATE_FORM_ALERT';
export const ADD_ALERT_QUEUE_CREATE = 'ADD_ALERT_QUEUE_CREATE';
export const RESET_ALERT_FORM = 'RESET_ALERT_FORM';
export const ADD_ALERT_TO_DELETE = 'ADD_ALERT_TO_DELETE';
export const FILTER_ALERTS_FROM_GROUPS = 'FILTER_ALERTS_FROM_GROUPS';
