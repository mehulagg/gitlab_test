...
<template>
  <div id="modal-shortcuts" class="modal-open">
    <div
      class="modal gl-display-block"
      data-close-modal="true"
      tabindex="-1"
      aria-modal="true"
      @click="closeModal"
    >
      <div class="modal-dialog modal-lg modal-1040">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <button
              ...
              @click="closeModal"
            >
              <span data-close-modal="true" aria-hidden="true">&times;</span>
            </button>
          </div>
