...
<template>
  ...
  >
    <td ref="td" :class="classNameMapTableCell" class="diff-line-num old_line">
      <diff-table-cell
        :file-hash="fileHash"
    ...
    <td ref="td" :class="classNameMapTableCell" class="diff-line-num new_line qa-new-diff-line">
      <diff-table-cell
        :file-hash="fileHash"
        :context-lines-path="contextLinesPath"
        :line="line"
