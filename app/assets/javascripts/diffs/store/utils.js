...
export const isAdded = line => ['new', 'new-nonewline'].indexOf(line.type) !== -1;
export const isRemoved = line => ['old', 'old-nonewline'].indexOf(line.type) !== -1;
export const isUnchanged = line => !line.type;
export const isMeta = line => ['match', 'new-nonewline', 'old-nonewline'].indexOf(line.type) !== -1;
...
function ensureBasicDiffFileLines(file) {
  if (window.gon?.features?.unifiedDiffLines) {
    return Object.assign(file, {
      lines: parallelizeDiffLines(file.highlighted_diff_lines),
      highlighted_diff_lines: null,
