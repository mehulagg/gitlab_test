...
import { GlIcon, GlButton, GlSprintf, GlLink, GlSafeHtmlDirective as SafeHtml } from '@gitlab/ui';
          ...
          <span class="btn-group">
            ...
            >
              <li>
                ...
                >
                  <span class="media">
                    <span v-safe-html="successSvg" class="merge-opt-icon" aria-hidden="true"></span>
              ...
              <li>
                ...
                >
                  <span class="media">
                    <span v-safe-html="warningSvg" class="merge-opt-icon" aria-hidden="true"></span>
