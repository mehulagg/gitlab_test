  ...
  <div>
    ...
    <div v-if="hasSuites" class="test-reports-table gl-mb-3 js-test-suites-table">
      <div role="row" class="gl-responsive-table-row table-row-header gl-font-weight-bold">
        <div role="rowheader" class="table-section section-25 gl-pl-6">
          {{ __('Job') }}
        </div>
        ...
        <div role="rowheader" class="table-section section-10 gl-pr-6 gl-text-right">
          {{ __('Total') }}
        </div>
      </div>
      ...
      >
        <div
          ...
          :key="index"
          role="row"
          class="gl-responsive-table-row test-reports-summary-row gl-rounded-base js-suite-row"
          :class="{
        ...
        >
          <div class="table-section section-25">
            ...
            <div class="table-mobile-content underline gl-text-gray-900 gl-pl-6">
              {{ testSuite.name }}
              <gl-icon
