...
<template>
  <gl-deprecated-button
    ...
    :class="cssClass"
    :disabled="isDisabled"
    class="js-ci-action btn gl-button-deprecated btn-blank btn-transparent ci-action-icon-container ci-action-icon-wrapper d-flex align-items-center justify-content-center"
    @click="onClickAction"
  >
