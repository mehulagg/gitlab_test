  ...
  <div class="pipeline-header-container">
    ...
    >
      <loading-button
        ...
        :loading="isRetrying"
        :disabled="isRetrying"
        class="js-retry-button btn gl-button-deprecated btn-inverted-secondary"
      ...
      <loading-button
        ...
        class="js-btn-cancel-pipeline btn gl-button-deprecated btn-danger"
        container-class="d-inline"
      ...
      <loading-button
        ...
        :loading="isDeleting"
        :disabled="isDeleting"
        class="js-btn-delete-pipeline btn gl-button-deprecated btn-danger btn-inverted"
        container-class="d-inline"
        :label="__('Delete')"
      />
    </ci-header>
