...
class User < ApplicationRecord
  ...
  scope :without_group_memberships, -> { left_outer_joins(:members).merge(Member.with_user(nil)) }
  scope :with_pending_group_memberships, -> { joins(:members).merge(Member.invite.or(Member.request)) }
