...
class Issue < ApplicationRecord
  ...
  scope :order_due_date_asc, -> { reorder('issues.due_date IS NULL').order(due_date: :asc) }
  scope :order_due_date_desc, -> { reorder('issues.due_date IS NULL').order(due_date: :desc) }
