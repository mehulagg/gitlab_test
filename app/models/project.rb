...
class Project < ApplicationRecord
  ...
  # Before 12.8 we did not correctly clean up chat names and this causes issues.
  # In 12.8, we add a foreign key relationship, but this code is used ensure the chat names are cleaned up while a post
  # migration enables the foreign key relationship.
  #
  # This should be removed in 12.9.
  #
  # See https://gitlab.com/gitlab-org/gitlab/issues/25230
