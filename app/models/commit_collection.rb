...
# A collection of Commit instances for a specific object with a repository and Git reference.
class CommitCollection
  include Enumerable
  include Gitlab::Utils::StrongMemoize

  attr_reader :repositorable, :ref, :commits

  delegate :repository, to: :repositorable
  delegate :project, to: :repository

  # subject - Object the commits belong to.
  # commits - The Commit instances to store.
  # ref - The name of the ref (e.g. "master").
  def initialize(repositorable, commits, ref = nil)
  ...
  def enrich!
    # A project or snippet is needed in order to fetch data from gitaly. Projects
