...
module EESpecificCheck
  WHITELIST = [
    ...
    'db/schema.rb',
    'locale/gitlab.pot',
    # List all directories under doc/
    'doc/*.md',
    ...
    'doc/user/**/*',
    'doc/user/security/**/*',
    'doc/user/security/dependency_scanning/**/*',
    'doc/user/security/dast/**/*',
    'doc/user/security/container_scanning/**/*',
    'doc/user/security/sast/**/*',
    'doc/user/security/license_management/**/*',
