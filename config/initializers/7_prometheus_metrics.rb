...
def prometheus_multiproc_dir
  dir = ENV['prometheus_multiproc_dir']
  dir ||= Rails.root.join('tmp/prometheus_multiproc_dir') if Rails.env.development? || Rails.env.test?
  dir
end

def remove_prometheus_multiproc_dir
  return unless prometheus_multiproc_dir
...
Prometheus::Client.configure do |config|
  ...
  config.multiprocess_files_dir = prometheus_multiproc_dir
...
Gitlab::Cluster::LifecycleEvents.on_master_start do
  remove_prometheus_multiproc_dir
end
