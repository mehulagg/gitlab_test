  ...
  module CommitStatusPresenter
    ...
    prepended do
      EE_CALLOUT_FAILURE_MESSAGES = const_get(:CALLOUT_FAILURE_MESSAGES).merge(
        ...
        downstream_bridge_insufficient_permissions: 'This job could not be executed because of insufficient permissions to create a downstream pipeline.',
        downstream_bridge_project_not_found: 'This job could not be executed because downstream bridge project could not be found.',
        downstream_bridge_invalid_trigger: 'This job could not be executed because downstream pipeline trigger definition is invalid.'
      ).freeze
