  ...
  module GeoHelper
    ...
    def toggle_node_button(node)
      ...
      link_to title,
              ...
              method: :post,
              class: "btn gl-button-deprecated btn-sm btn-#{btn_class}",
              title: title,
              data: data
    end
    ...
    def resync_all_button
      button_to(s_("Geo|Resync all"), { controller: controller_name, action: :resync_all }, class: "btn gl-button-deprecated btn-default btn-md mr-2")
    end

    def reverify_all_button
      button_to(s_("Geo|Reverify all"), { controller: controller_name, action: :reverify_all }, class: "btn gl-button-deprecated btn-default btn-md")
    end
  end
end
