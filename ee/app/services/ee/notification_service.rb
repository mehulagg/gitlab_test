...
module EE
  module NotificationService
    ...
    def send_new_review_notification(review)
      recipients = ::NotificationRecipients::Service.build_new_review_recipients(review)
    ...
    def approve_mr_email(merge_request, project, current_user)
      recipients = ::NotificationRecipients::Service.build_recipients(merge_request, current_user, action: 'approve')
    ...
    def unapprove_mr_email(merge_request, project, current_user)
      recipients = ::NotificationRecipients::Service.build_recipients(merge_request, current_user, action: 'unapprove')
