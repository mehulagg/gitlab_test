...
module MergeTrains
  class CreatePipelineService < BaseService
    ...
    def validate(merge_request)
      ...
      return error('fork merge request is not supported') if !Gitlab::Ci::Features.allow_to_create_merge_request_pipelines_in_target_project?(merge_request.target_project) && merge_request.for_fork?
