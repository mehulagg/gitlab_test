...
module EE
  ...
  module Project
    ...
    prepended do
      ...
      has_many :upstream_project_sources, class_name: 'Ci::Sources::Project', foreign_key: :project_id
      has_many :downstream_project_sources, class_name: 'Ci::Sources::Project', foreign_key: :source_project_id

      has_many :upstream_projects, through: :upstream_project_sources, source: :source_project
      has_many :downstream_projects, through: :downstream_project_sources, source: :project
