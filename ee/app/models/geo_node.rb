...
class GeoNode < ApplicationRecord
  ...
  def lfs_objects
    ...
    # Adding DISTINCT directly to this query instead of doing this subquery
    # increases execution time dramatically
    ids_with_dupes = LfsObject.joins(:lfs_objects_projects)
                              .where(lfs_objects_projects: { project_id: projects })

    LfsObject.where(id: ids_with_dupes)
  end
