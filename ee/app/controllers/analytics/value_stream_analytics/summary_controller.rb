  ...
  module ValueStreamAnalytics
    class SummaryController < Analytics::ApplicationController
      ...
      def show
        ...
        group_level = ::ValueStreamAnalytics::GroupLevel.new(group: @group, options: options(group_params))
      ...
      def request_params
        @request_params ||= Gitlab::Analytics::ValueStreamAnalytics::RequestParams.new(allowed_params)
      end
