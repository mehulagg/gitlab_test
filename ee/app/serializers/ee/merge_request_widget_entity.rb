...
module EE
  module MergeRequestWidgetEntity
    ...
    prepended do
      ...
      expose :merge_trains_summary, using: ::MergeTrainsSummaryEntity, if: -> (*) { merge_pipelines_enabled? } do |merge_request|
        merge_request
      end

      expose :merge_train, if: -> (merge_request) { merge_request.on_train? }, using: ::MergeTrainEntity
