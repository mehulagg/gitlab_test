  ...
  <div class="inline">
    ...
    >
      ...
      <template #modal-footer>
        ...
        <gl-dropdown v-if="shouldShowChanges" dropup right split :split-href="link" data-track-event="open_review_app" data-track-label="review_app" @click="ok">
          ...
          <div v-show="filteredChanges.length === 0" class="text-secondary p-2">{{ s__('Nothing found...') }}</div>
        </gl-dropdown>
        <review-app-link
          v-else
