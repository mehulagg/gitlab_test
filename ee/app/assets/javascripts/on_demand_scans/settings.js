...
export const getProfilesSettings = ({
  ...
  scannerProfiles: {
    ...
    i18n: {
      title: s__('OnDemandScans|Scanner profiles'),
    ...
    summary: [
      [[s__('DastProfiles|Scan mode'), () => s__('DastProfiles|Passive')]],
      [
        [s__('DastProfiles|Spider timeout'), profile => profile.spiderTimeout],
        [s__('DastProfiles|Target timeout'), profile => profile.targetTimeout],
      ],
    ],
  },
  siteProfiles: {
    ...
    i18n: {
      title: s__('OnDemandScans|Site profiles'),
    ...
    summary: [[[s__('DastProfiles|Target URL'), profile => profile.targetUrl]]],
  },
});
