...
export default {
  ...
  data() {
    const form = {
      profileName: initField(this.profile.name, true),
      spiderTimeout: initField(this.profile.spiderTimeout, true),
      targetTimeout: initField(this.profile.targetTimeout, true),
    };
