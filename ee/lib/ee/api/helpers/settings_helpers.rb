        ...
        prepended do
          params :optional_params_ee do
            ...
            given elasticsearch_indexing: ->(val) { val } do
              ...
              requires :elasticsearch_url, type: String, desc: 'The url to use for connecting to Elasticsearch. Use a comma-separated list to support clustering (e.g., "http://host1:9200, http://host2:9201")'
