...
describe Analytics::ValueStreamAnalytics::Stages::UpdateService do
  ...
  context 'when updating a default stage' do
    let(:stage) { Analytics::ValueStreamAnalytics::GroupStage.new(default_stages.first.merge(group: group)) }
    ...
    context 'when the first update happens on a default stage' do
      ...
      context 'when the update fails' do
        before do
          invalid_stage = Analytics::ValueStreamAnalytics::GroupStage.new(name: '')
