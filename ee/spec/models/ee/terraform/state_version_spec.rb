  ...
  describe '.replicables_for_geo_node' do
    ...
    with_them do
      ...
      before do
        ...
        stub_terraform_state_version_object_storage(Terraform::VersionedStateUploader) if terraform_object_storage_enabled
