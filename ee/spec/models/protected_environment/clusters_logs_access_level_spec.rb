...
RSpec.describe ProtectedEnvironment::ClustersLogsAccessLevel do
  describe 'associations' do
    it { is_expected.to belong_to(:protected_environment).inverse_of(:clusters_logs_access_levels) }
    it { is_expected.to belong_to(:user).inverse_of(:protected_environment_clusters_logs_access_level) }
    it { is_expected.to belong_to(:group).inverse_of(:protected_environment_clusters_logs_access_level) }
  end
