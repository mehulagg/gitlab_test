...
describe IssueLink do
  ...
  describe '.blocking_issues_ids_for' do
    it 'returns blocking issues ids' do
      issue = create(:issue)
      ...
      blocking_ids = described_class.blocking_issues_ids_for(issue).pluck(:blocking_issue_id)
