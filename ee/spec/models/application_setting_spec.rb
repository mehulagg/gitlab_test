...
describe ApplicationSetting do
  ...
  describe 'validations' do
    ...
    it { is_expected.to allow_value(nil).for(:required_ci_template) }
    it { is_expected.not_to allow_value("").for(:required_ci_template) }
    it { is_expected.not_to allow_value("  ").for(:required_ci_template) }
    it { is_expected.to allow_value("template_name").for(:required_ci_template) }
