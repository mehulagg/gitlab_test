...
describe Gitlab::Graphql::Aggregations::Epics::EpicNode do
  ...
  describe 'recursive totals' do
    ...
    shared_examples 'returns recursive totals by facet' do |facet, state, type, value|
      it "returns the correct value for #{facet}" do
        result = subject.sum_objects(facet, state, type)
    ...
    context 'an epic with no child epics' do
      context 'with no child issues', :aggregate_results do
        ...
        it_behaves_like 'returns recursive totals by facet', COUNT, OPENED_EPIC_STATE, EPIC_TYPE, 0
      ...
      context 'with an issue with 0 weight', :aggregate_results do
        ...
        it_behaves_like 'returns recursive totals by facet', COUNT, OPENED_ISSUE_STATE, ISSUE_TYPE, 1
        it_behaves_like 'returns recursive totals by facet', WEIGHT_SUM, OPENED_ISSUE_STATE, ISSUE_TYPE, 0
        it_behaves_like 'returns recursive totals by facet', COUNT, CLOSED_ISSUE_STATE, ISSUE_TYPE, 0
        it_behaves_like 'returns recursive totals by facet', WEIGHT_SUM, CLOSED_ISSUE_STATE, ISSUE_TYPE, 0

        it_behaves_like 'returns recursive totals by facet', COUNT, OPENED_EPIC_STATE, EPIC_TYPE, 0
        it_behaves_like 'returns recursive totals by facet', COUNT, CLOSED_EPIC_STATE, EPIC_TYPE, 0
      ...
      context 'with an issue with nonzero weight' do
        ...
        it_behaves_like 'returns recursive totals by facet', COUNT, OPENED_ISSUE_STATE, ISSUE_TYPE, 1
        it_behaves_like 'returns recursive totals by facet', WEIGHT_SUM, OPENED_ISSUE_STATE, ISSUE_TYPE, 2
        it_behaves_like 'returns recursive totals by facet', COUNT, CLOSED_ISSUE_STATE, ISSUE_TYPE, 0
        it_behaves_like 'returns recursive totals by facet', WEIGHT_SUM, CLOSED_ISSUE_STATE, ISSUE_TYPE, 0
    ...
    context 'an epic with child epics' do
      ...
      context 'with a child that has issues of nonzero weight' do
        ...
        it_behaves_like 'returns recursive totals by facet', COUNT, OPENED_EPIC_STATE, EPIC_TYPE, 1
        it_behaves_like 'returns recursive totals by facet', COUNT, CLOSED_EPIC_STATE, EPIC_TYPE, 0
  ...
  def record_for(epic_id:, parent_id:, epic_state_id:, issues_state_id:, issues_count:, issues_weight_sum:)
    { epic_id: epic_id, issues_count: issues_count, issues_weight_sum: issues_weight_sum, parent_id: parent_id, issues_state_id: issues_state_id, epic_state_id: epic_state_id }
  end
end
