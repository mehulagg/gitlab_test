...
describe('Feature flags', () => {
  ...
  describe('without permissions', () => {
    ...
    beforeEach(done => {
      mock
        .onGet(`${TEST_HOST}/endpoint.json`, { params: { scope: 'featureFlags', page: '1' } })
  ...
  describe('successful request', () => {
    describe('without feature flags', () => {
      ...
      beforeEach(done => {
        mock.onGet(mockData.endpoint, { params: { scope: 'featureFlags', page: '1' } }).replyOnce(
          200,
          {
            feature_flags: [],
            count: {
    ...
    describe('with paginated feature flags', () => {
      beforeEach(done => {
        mock
          .onGet(mockData.endpoint, { params: { scope: 'featureFlags', page: '1' } })
          .replyOnce(200, getRequestData, {
            'x-next-page': '2',
            'x-page': '1',
            'X-Per-Page': '2',
      ...
      describe('pagination', () => {
        ...
        it('should make an API request when using tabs', () => {
          jest.spyOn(wrapper.vm, 'updateFeatureFlagOptions');
          wrapper.find(NavigationTabs).vm.$emit('onChangeTab', 'userLists');
