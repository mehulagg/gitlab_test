...
import mutations from 'ee/security_dashboard/store/modules/projectSelector/mutations';
...
describe('projectsSelector mutations', () => {
  ...
  describe('SET_PROJECTS', () => {
    ...
    it.each([null, false, undefined, NaN])(
      'sets "projects" to be an empty array given a falsy payload',
      falsyProjectsValue => {
        state.projects = falsyProjectsValue;

        mutations[types.SET_PROJECTS](state);
