...
describe('Threat Monitoring actions', () => {
  ...
  describe('setCurrentEnvironmentId', () => {
    ...
    it('commits the SET_CURRENT_ENVIRONMENT_ID mutation and dispatches data fetch actions', () =>
      testAction(
  ...
  describe('setCurrentTimeWindow', () => {
    ...
    it('commits the SET_CURRENT_TIME_WINDOW mutation and dispatches data fetch actions', () =>
      testAction(
