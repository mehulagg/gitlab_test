...
describe('GeoNodeForm Store Actions', () => {
  ...
  describe.each`
    ...
    ${actions.receiveSaveGeoNodeSuccess}    | ${null}                 | ${types.RECEIVE_SAVE_GEO_NODE_SUCCESS}   | ${{ type: types.RECEIVE_SAVE_GEO_NODE_SUCCESS }}                                  | ${visitUrlCallback}
    ${actions.receiveSaveGeoNodeError}      | ${null}                 | ${types.RECEIVE_SAVE_GEO_NODE_ERROR}     | ${{ type: types.RECEIVE_SAVE_GEO_NODE_ERROR }}                                    | ${flashCallback}
