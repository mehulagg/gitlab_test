...
describe Analytics::ValueStreamAnalytics::StagesController do
  ...
  describe 'GET `index`' do
    ...
    it 'renders `forbidden` based on the response of the service object' do
      expect_any_instance_of(Analytics::ValueStreamAnalytics::Stages::ListService).to receive(:can?).and_return(false)
