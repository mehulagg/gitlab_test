...
describe GitlabSchema.types['Project'] do
  ...
  it 'includes the ee specific fields' do
    expected_fields = %w[service_desk_enabled service_desk_address vulnerabilities vulnerabilities_summary]
  ...
  describe 'vulnerabilities_summary' do
    let_it_be(:query) do
      %(
        query {
          project(fullPath:"#{project.full_path}") {
    ...
    context 'when first_class_vulnerabilities is enabled' do
      ...
      it "returns the project's vulnerabilities summary" do
