  ...
  context "with a project" do
    ...
    describe '#resolve' do
      ...
      it 'filters by any assignee' do
        expect(resolve_issues(assignee_id: IssuableFinderParams::FILTER_ANY)).to contain_exactly(issue2)
      end

      it 'filters by no assignee' do
        expect(resolve_issues(assignee_id: IssuableFinderParams::FILTER_NONE)).to contain_exactly(issue1)
      end
