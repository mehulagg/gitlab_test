...
require 'spec_helper'
require Rails.root.join('db', 'post_migrate', '20200609075351_remove_gitlab_issue_tracker_service_records.rb')

describe RemoveGitlabIssueTrackerServiceRecords do
