require 'spec_helper'
require Rails.root.join('db', 'post_migrate', '20200306102535_add_partial_temporary_index_to_services_on_project_id_spec.rb.rb')

describe AddPartialTemporaryIndexToServicesOnProjectId, :migration do
