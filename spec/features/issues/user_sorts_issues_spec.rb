...
describe "User sorts issues" do
  ...
  let_it_be(:issue1, reload: true) { create(:issue, title: 'foo', created_at: Time.current, project: project) }
  let_it_be(:issue2, reload: true) { create(:issue, title: 'bar', created_at: Time.current - 60, project: project) }
  let_it_be(:issue3, reload: true) { create(:issue, title: 'baz', created_at: Time.current - 120, project: project) }
  ...
  it 'sorts by most recently updated' do
    issue3.updated_at = Time.current + 100
    issue3.save
