  ...
  context 'as owner' do
    ...
    context 'fork level access' do
      context 'when the feature flag is enabled' do
        ...
        disabled = %w[Public Internal]

        it 'shows the "forks" settings panel for "Private" projects' do
          visit edit_project_path(project)
          select_project_visibility('Private')
      ...
      context 'when the feature flag is disabled' do
        ...
        disabled = %w[Private Public Internal]
