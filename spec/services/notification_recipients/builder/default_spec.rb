...
describe NotificationRecipients::Builder::Default do
  describe '#build!' do
    ...
    let_it_be(:notification_setting) { create(:notification_setting, source: project, user: project_watcher, level: 2) }
    let_it_be(:notification_setting) { create(:notification_setting, source: group, user: group_watcher, level: 2) }
