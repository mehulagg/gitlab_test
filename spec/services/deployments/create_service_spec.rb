...
describe Deployments::CreateService do
  ...
  describe '#create_deployment_for_deployable!' do
    it 'creates a deployment for a CI build' do
      deployable = double(:deployable)
      service = described_class.new(environment, user, {})
      ...
      service.create_deployment_for_deployable!(deployable)
    end
  end
