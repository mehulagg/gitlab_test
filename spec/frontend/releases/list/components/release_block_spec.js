...
describe('Release block', () => {
  ...
  it('renders commit sha', () => {
    ...
    return factory({ release: releaseClone }).then(() => {
  ...
  it('does not render an edit button if showEditButton !== true', () =>
    factory({ showEditButton: false }).then(() => {
  ...
  it('does not render an edit button if the releaseEditPage feature flag is disabled', () =>
    factory({}, { releaseEditPage: false }).then(() => {
      expect(editButton().exists()).toBe(false);
    }));
