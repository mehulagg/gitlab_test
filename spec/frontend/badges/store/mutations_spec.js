...
describe('Badges store mutations', () => {
  ...
  describe('RECEIVE_DELETE_BADGE', () => {
    beforeEach(() => {
      ...
      store.replaceState({ ...store.state, badges });
    });
  ...
  describe('RECEIVE_LOAD_BADGES', () => {
    beforeEach(() => {
      store.replaceState({ ...store.state, isLoading: 'not false' });
    });
  ...
  describe('RECEIVE_NEW_BADGE_ERROR', () => {
    beforeEach(() => {
      store.replaceState({ ...store.state, isSaving: 'dummy value' });
    });
  ...
  describe('RECEIVE_RENDERED_BADGE_ERROR', () => {
    beforeEach(() => {
      store.replaceState({ ...store.state, isRendering: 'dummy value' });
    });
  ...
  describe('UPDATE_BADGE_IN_MODAL', () => {
    beforeEach(() => {
      store.replaceState({ ...store.state, badgeInModal: 'dummy value' });
    });
