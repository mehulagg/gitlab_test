...
describe('Badges store actions', () => {
  ...
  beforeEach(() => {
    ...
    state = { ...createState(), apiEndpointUrl: dummyEndpointUrl, badges: dummyBadges };
  ...
  describe('requestDeleteBadge', () => {
    it('commits REQUEST_DELETE_BADGE', done => {
      testAction(
        ...
        [
          {
            type: mutationTypes.REQUEST_DELETE_BADGE,
            payload: badgeId,
          },
        ],
        [],
  ...
  describe('receiveDeleteBadge', () => {
    it('commits RECEIVE_DELETE_BADGE', done => {
      testAction(
        ...
        [
          {
            type: mutationTypes.RECEIVE_DELETE_BADGE,
            payload: badgeId,
          },
        ],
        [],
  ...
  describe('receiveDeleteBadgeError', () => {
    it('commits RECEIVE_DELETE_BADGE_ERROR', done => {
      testAction(
        ...
        [
          {
            type: mutationTypes.RECEIVE_DELETE_BADGE_ERROR,
            payload: badgeId,
          },
        ],
        [],
  ...
  describe('editBadge', () => {
    it('commits START_EDITING', done => {
      ...
      testAction(
        ...
        [
          {
            type: mutationTypes.START_EDITING,
            payload: dummyBadge,
          },
        ],
        [],
  ...
  describe('receiveRenderedBadge', () => {
    it('commits RECEIVE_RENDERED_BADGE', done => {
      ...
      testAction(
        ...
        [
          {
            type: mutationTypes.RECEIVE_RENDERED_BADGE,
            payload: dummyBadge,
          },
        ],
        [],
  ...
  describe('renderBadge', () => {
    ...
    beforeEach(() => {
      ...
      state = { ...state, badgeInAddForm: badgeInForm };
      const urlParameters = [
    ...
    it('escapes user input', done => {
      jest.spyOn(axios, 'get').and.callFake(() =>
        Promise.resolve({
          data: createDummyBadgeResponse(),
        }),
      );
  ...
  describe('receiveUpdatedBadge', () => {
    it('commits RECEIVE_UPDATED_BADGE', done => {
      ...
      testAction(
        ...
        [
          {
            type: mutationTypes.RECEIVE_UPDATED_BADGE,
  ...
  describe('updateBadgeInForm', () => {
    it('commits UPDATE_BADGE_IN_FORM', done => {
      ...
      testAction(
        ...
        [
          {
            type: mutationTypes.UPDATE_BADGE_IN_FORM,
            payload: dummyBadge,
          },
        ],
        [],
    ...
    describe('updateBadgeInModal', () => {
      it('commits UPDATE_BADGE_IN_MODAL', done => {
        ...
        testAction(
          ...
          [
            {
              type: mutationTypes.UPDATE_BADGE_IN_MODAL,
              payload: dummyBadge,
            },
          ],
          [],
