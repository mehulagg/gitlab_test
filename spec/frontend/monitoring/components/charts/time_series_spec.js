...
import { metricsGroupsAPIResponse, deploymentData, mockProjectDir } from '../../mock_data';
...
describe('Time series component', () => {
  ...
  const projectPath = `${TEST_HOST}${mockProjectDir}`;
