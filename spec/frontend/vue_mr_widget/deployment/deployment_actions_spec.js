// actions tests
// most of the interaction tests:
// - should show a confirm dialog but should not work if the dialog is rejected
// - should show a confirm dialog and call service.stopEnvironment when confirmed (but all of them)
