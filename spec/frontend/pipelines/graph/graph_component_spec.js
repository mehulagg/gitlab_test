...
describe('graph component', () => {
  ...
  describe('when linked pipelines are present', () => {
    ...
    describe('rendered output', () => {
      ...
      it('should include the gl-mr-26 class on the first child', () => {
        expect(findStageColumnAt(0).classes('gl-mr-26')).toBe(true);
      });

      it('should include the has-only-one-job class on the first child', () => {
        expect(findStageColumnAt(0).classes('has-only-one-job')).toBe(true);
      });
    ...
    describe('linked pipelines components', () => {
      ...
      describe('triggered', () => {
        ...
        describe('when column requests a refresh', () => {
          beforeEach(() => {
            wrapper.find(StageColumnComponent).vm.$emit('refreshPipelineGraph');
          });
