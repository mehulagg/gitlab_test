...
describe SnippetsController do
  ...
  describe "GET #raw" do
    ...
    context 'when the personal snippet is private' do
      let(:personal_snippet) { create(:personal_snippet, :private, :repository, author: user) }
    ...
    context 'when the personal snippet is internal' do
      let(:personal_snippet) { create(:personal_snippet, :internal, :repository, author: user) }
    ...
    context 'when the personal snippet is public' do
      let(:personal_snippet) { create(:personal_snippet, :public, :repository, author: user) }
