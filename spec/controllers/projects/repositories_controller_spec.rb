  ...
  describe "GET archive" do
    ...
    context "as a user" do
      ...
      it "responds with redirect to the short name archive if fully qualified" do
        get_archive("master/#{archive_name}")
      ...
      it "responds with redirect for a path with multiple slashes" do
        get_archive("improve/awesome/#{archive_name}")
      ...
      describe "caching" do
        ...
        def get_archive(id = "feature", request_format: "zip")
          get :archive, params: { namespace_id: project.namespace, project_id: project, id: id }, format: request_format
        end
      end
    end
