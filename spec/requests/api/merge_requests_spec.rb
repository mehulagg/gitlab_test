...
describe API::MergeRequests do
  ...
  describe "GET /projects/:id/merge_requests" do
    ...
    context 'a project which enforces all discussions to be resolved', :use_clean_rails_memory_store_caching do
      let!(:project) { create(:project, :repository, only_allow_merge_if_all_discussions_are_resolved: true) }

      context 'with mergeable_discussions_state field cached' do
        it 'avoids N+1 queries' do
          control = ActiveRecord::QueryRecorder.new do
            get api("/projects/#{project.id}/merge_requests", user)
          end.count

          create(:merge_request, author: user, assignees: [user],
            source_project: project, target_project: project, created_at: base_time)
