...
describe API::MergeRequests do
  ...
  describe "DELETE /projects/:id/merge_requests/:merge_request_iid" do
    ...
    context "when the user is project owner" do
      ...
      it "returns 404 for an invalid merge request IID" do
        delete api("/projects/#{project.id}/merge_requests/#{non_existing_record_id}", user)
  ...
  describe "PUT /projects/:id/merge_requests/:merge_request_iid/merge", :clean_gitlab_redis_cache do
    ...
    it "returns 404 for an invalid merge request IID" do
      put api("/projects/#{project.id}/merge_requests/#{non_existing_record_id}/merge", user)
  ...
  describe "PUT /projects/:id/merge_requests/:merge_request_iid" do
    ...
    it "returns 404 for an invalid merge request IID" do
      put api("/projects/#{project.id}/merge_requests/#{non_existing_record_id}", user), params: { state_event: "close" }
  ...
  describe 'GET :id/merge_requests/:merge_request_iid/closes_issues' do
    ...
    it "returns 404 for an invalid merge request IID" do
      get api("/projects/#{project.id}/merge_requests/#{non_existing_record_id}/closes_issues", user)
