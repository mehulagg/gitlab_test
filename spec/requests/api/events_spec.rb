  ...
  describe 'GET /users/:id/events' do
    ...
    context "as a user that can see the event's project" do
      ...
      context 'when the list of events includes wiki page events' do
        ...
        before do
          EventCreateService.new.wiki_event(page, Event::CREATED, nil)
          EventCreateService.new.wiki_event(page, Event::UPDATED, nil)
          EventCreateService.new.wiki_event(page, Event::DESTROYED, nil)
        end
