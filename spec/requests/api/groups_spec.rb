  ...
  describe "POST /groups" do
    context "when authenticated as user without group permissions" do
      it "does not create group" do
        group = attributes_for(:group).except(:project_creation_level, :subgroup_creation_level)
    ...
    context "when authenticated as user with group permissions" do
      it "creates group" do
        group = attributes_for(:group, { request_access_enabled: false }).except(:project_creation_level, :subgroup_creation_level)
      ...
      it "creates a nested group" do
        ...
        group = attributes_for(:group, { parent_id: parent.id }).except(:project_creation_level, :subgroup_creation_level)
