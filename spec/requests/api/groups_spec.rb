...
RSpec.describe API::Groups do
  ...
  describe 'GET /groups/:id/descendants' do
    ...
    context 'when unauthenticated' do
      it 'returns only public descendants' do
        get api("/groups/#{group1.id}/descendants")
      ...
      it 'returns 404 for a private group' do
        get api("/groups/#{group2.id}/descendants")
    ...
    context 'when authenticated as user' do
      context 'when user is not member of a public group' do
        it 'returns no descendants for the public group' do
          get api("/groups/#{group1.id}/descendants", user2)
        ...
        context 'when using all_available in request' do
          it 'returns public descendants' do
            get api("/groups/#{group1.id}/descendants", user2), params: { all_available: true }
      ...
      context 'when user is not member of a private group' do
        it 'returns 404 for the private group' do
          get api("/groups/#{group2.id}/descendants", user1)
      ...
      context 'when user is member of public group' do
        ...
        context 'when using statistics in request' do
          it 'does not include statistics' do
            get api("/groups/#{group1.id}/descendants", user2), params: { statistics: true }
    ...
    context 'when authenticated as admin' do
      it 'returns private descendants of a public group' do
        get api("/groups/#{group1.id}/descendants", admin)
      ...
      it 'returns descendants of a private group' do
        get api("/groups/#{group2.id}/descendants", admin)
      ...
      it 'includes statistics if requested' do
        get api("/groups/#{group1.id}/descendants", admin), params: { statistics: true }
