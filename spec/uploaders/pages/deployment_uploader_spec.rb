...
RSpec.describe Pages::DeploymentUploader do
  ...
  it_behaves_like "builds correct paths",
                  ...
                  cache_dir: %r[pages/@zip/tmp/cache],
                  work_dir: %r[pages/@zip/tmp/work]
  ...
  context 'when file is stored in valid local_path' do
    ...
    it { is_expected.to match(%r[#{uploader.root}/#{uploader.class.base_dir}/\h{2}/\h{2}/\h{64}/pages_deployments/#{pages_deployment.id}/pages.zip]) }
  end
end
