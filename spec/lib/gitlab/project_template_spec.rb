  ...
  describe '.all' do
    it 'returns a all templates' do
      expected = [
        ...
        described_class.new('cluster_management', 'GitLab Cluster Management', _('An example project for managing Kubernetes clusters integrated with GitLab.'), 'https://gitlab.com/gitlab-org/cluster-integration/example-cluster-applications')
      ]
