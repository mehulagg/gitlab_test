...
describe Gitlab::Analytics::ValueStreamAnalytics::RecordsFetcher do
  around do |example|
  ...
  subject do
    Gitlab::Analytics::ValueStreamAnalytics::DataCollector.new(
      stage: stage,
      params: {
        from: 1.year.ago,
        current_user: user
  ...
  describe '#serialized_records' do
    ...
    describe 'special case' do
      ...
      let(:default_stages) { Gitlab::Analytics::ValueStreamAnalytics::DefaultStages }
