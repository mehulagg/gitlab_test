...
describe Gitlab::DatabaseImporters::CustomDashboard::Importer do
  ...
  let_it_be(:project) do
    create(:project, :custom_repo, files: {
      '.gitlab/dashboards/sample.yml' => fixture_file('lib/gitlab/metrics/dashboard/sample_dashboard.yml')
      }
    )
  end

  describe '.import_dashboards!' do
    before do
      described_class.import_dashboards
    end
  end
