...
describe MilestoneArray do
  let(:object1) { instance_double("BirdMilestone", due_date: Time.current, start_date: Time.current - 15.days, title: 'v2.0') }
  let(:object2) { instance_double("CatMilestone", due_date: Time.current - 1.day, start_date: nil, title: 'v1.0') }
  let(:object3) { instance_double("DogMilestone", due_date: nil, start_date: Time.current - 30.days, title: 'v3.0') }
