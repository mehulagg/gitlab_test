...
RSpec.describe 'project routing' do
  ...
  describe Projects::RefsController, 'routing' do
    ...
    it_behaves_like 'redirecting a legacy project path', '/gitlab/gitlabhq/refs/switch', '/gitlab/gitlabhq/-/refs/switch'

    it_behaves_like 'redirecting a legacy project path',
  ...
  describe Projects::CommitController, 'routing' do
    ...
    it_behaves_like 'redirecting a legacy project path', "/gitlab/gitlabhq/commit/4246fbd", "/gitlab/gitlabhq/-/commit/4246fbd"
  end
  ...
  describe Projects::CommitsController, 'routing' do
    ...
    it_behaves_like 'redirecting a legacy project path', "/gitlab/gitlabhq/commits/master", "/gitlab/gitlabhq/-/commits/master"
  end
  ...
  describe Projects::FindFileController, 'routing' do
    ...
    it_behaves_like 'redirecting a legacy project path', "/gitlab/gitlabhq/find_file", "/gitlab/gitlabhq/-/find_file"
    it_behaves_like 'redirecting a legacy project path', "/gitlab/gitlabhq/files/master", "/gitlab/gitlabhq/-/files/master"
  end
  ...
  describe Projects::BlobController, 'routing' do
    ...
    it_behaves_like 'redirecting a legacy project path', "/gitlab/gitlabhq/new/master", "/gitlab/gitlabhq/-/new/master"
    it_behaves_like 'redirecting a legacy project path', "/gitlab/gitlabhq/edit/master/README", "/gitlab/gitlabhq/-/edit/master/README"
  end
  ...
  describe Projects::CompareController, 'routing' do
    ...
    it_behaves_like 'redirecting a legacy project path', '/gitlab/gitlabhq/compare', '/gitlab/gitlabhq/-/compare'
    it_behaves_like 'redirecting a legacy project path', '/gitlab/gitlabhq/compare/master...stable', '/gitlab/gitlabhq/-/compare/master...stable'
  end
