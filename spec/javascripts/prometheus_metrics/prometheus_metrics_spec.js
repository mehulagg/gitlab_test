...
import { metrics, missingVarMetrics, customMetrics } from './mock_data';
...
describe('PrometheusMetrics', () => {
  ...
  describe('Custom Metrics', () => {
    ...
    it('should show monitored metrics list', () => {
      prometheusMetrics.customMetrics = customMetrics;
      ...
      expect($metricsListLi.length).toEqual(customMetrics.length);
    });
