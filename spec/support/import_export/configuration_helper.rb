...
module ConfigurationHelper
  ...
  def parsed_attributes(relation_name, attributes, config: Gitlab::ImportExport.config_file)
    ...
    attributes = attributes - Gitlab::Json.[](excluded_attributes.to_json) if excluded_attributes
    attributes = attributes & Gitlab::Json.[](included_attributes.to_json) if included_attributes
