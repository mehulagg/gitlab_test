...
RSpec.shared_examples 'valid dashboard service response' do
  let(:dashboard_schema) { JSON.parse(File.read(Rails.root.join('lib/gitlab/metrics/dashboard/schemas/full/dashboard.json'))) }
...
RSpec.shared_examples 'valid embedded dashboard service response' do
  let(:dashboard_schema) { JSON.parse(File.read(Rails.root.join('lib/gitlab/metrics/dashboard/schemas/embed/dashboard.json'))) }
