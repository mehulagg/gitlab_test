...
ActiveRecord::Schema.define(version: 2020_01_30_212450) do
  ...
  create_table "security_scans", force: :cascade do |t|
    ...
    t.index ["build_id", "pipeline_id", "scan_type"], name: "idx_security_scans_on_build_pipeline_and_scan_type", unique: true
    t.index ["pipeline_id"], name: "idx_security_scans_on_pipeline_id"
  ...
  add_foreign_key "security_scans", "ci_pipelines", column: "pipeline_id", on_delete: :cascade
