...
ActiveRecord::Schema.define(version: 20190604175329) do
  ...
  add_foreign_key "operations_feature_flag_strategies", "operations_feature_flag_scopes", column: "feature_flag_scope_id", on_delete: :cascade
