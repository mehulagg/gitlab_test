...
CREATE INDEX index_merge_request_diffs_external_diff_store_is_null ON merge_request_diffs USING btree (id) WHERE (external_diff_store IS NULL);
...
CREATE INDEX index_security_findings_on_scan_id ON security_findings USING btree (scan_id);
