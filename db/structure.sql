...
CREATE TABLE public.application_settings (
    ...
    default_project_visibility integer DEFAULT '-1'::integer NOT NULL,
    default_snippet_visibility integer DEFAULT '-1'::integer NOT NULL,
    ...
    default_group_visibility integer DEFAULT '-1'::integer,
