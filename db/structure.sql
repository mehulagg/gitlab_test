...
CREATE TABLE public.issue_milestones (
...
CREATE TABLE public.merge_request_milestones (
...
CREATE INDEX epic_mentions_temp_index ON public.notes USING btree (id) WHERE ((note ~~ '%@%'::text) AND ((noteable_type)::text = 'Epic'::text));
...
CREATE UNIQUE INDEX index_issue_milestones_on_issue_id ON public.issue_milestones USING btree (issue_id);

CREATE UNIQUE INDEX index_issue_milestones_on_issue_id_and_milestone_id ON public.issue_milestones USING btree (issue_id, milestone_id);

CREATE INDEX index_issue_milestones_on_milestone_id ON public.issue_milestones USING btree (milestone_id);
...
CREATE UNIQUE INDEX index_merge_request_milestones_on_merge_request_id ON public.merge_request_milestones USING btree (merge_request_id);

CREATE INDEX index_merge_request_milestones_on_milestone_id ON public.merge_request_milestones USING btree (milestone_id);
...
CREATE UNIQUE INDEX index_mrs_milestones_on_mr_id_and_milestone_id ON public.merge_request_milestones USING btree (merge_request_id, milestone_id);
...
CREATE UNIQUE INDEX index_packages_conan_metadata_on_package_id ON public.packages_conan_metadata USING btree (package_id);
...
CREATE INDEX index_pages_domains_on_domain_type ON public.pages_domains USING btree (domain_type);
...
CREATE INDEX index_projects_api_vis20_created_at_id_desc ON public.projects USING btree (created_at, id DESC) WHERE (visibility_level = 20);
...
CREATE INDEX index_projects_api_vis20_last_activity_at_id_desc ON public.projects USING btree (last_activity_at, id DESC) WHERE (visibility_level = 20);

CREATE INDEX index_projects_api_vis20_name ON public.projects USING btree (name, id) WHERE (visibility_level = 20);

CREATE INDEX index_projects_api_vis20_name_id_desc ON public.projects USING btree (name, id DESC) WHERE (visibility_level = 20);

CREATE INDEX index_projects_api_vis20_path ON public.projects USING btree (path, id) WHERE (visibility_level = 20);

CREATE INDEX index_projects_api_vis20_path_id_desc ON public.projects USING btree (path, id DESC) WHERE (visibility_level = 20);

CREATE INDEX index_projects_api_vis20_updated_at ON public.projects USING btree (updated_at, id) WHERE (visibility_level = 20);

CREATE INDEX index_projects_api_vis20_updated_at_id_desc ON public.projects USING btree (updated_at, id DESC) WHERE (visibility_level = 20);
...
CREATE INDEX tmp_index_on_project_id_partial_with_prometheus_services ON public.services USING btree (project_id) WHERE ((type)::text = 'PrometheusService'::text);
...
ALTER TABLE ONLY public.merge_request_milestones
    ADD CONSTRAINT fk_rails_212ba37b52 FOREIGN KEY (merge_request_id) REFERENCES public.merge_requests(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.merge_request_milestones
    ADD CONSTRAINT fk_rails_6da5e88b3c FOREIGN KEY (milestone_id) REFERENCES public.milestones(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.issue_milestones
    ADD CONSTRAINT fk_rails_b3daad894f FOREIGN KEY (milestone_id) REFERENCES public.milestones(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.issue_milestones
    ADD CONSTRAINT fk_rails_ff90aaa198 FOREIGN KEY (issue_id) REFERENCES public.issues(id) ON DELETE CASCADE;
