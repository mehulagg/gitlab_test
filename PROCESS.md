...
[upgrade](https://gitlab.com/gitlab-org/gitlab-foss/tree/master/doc/update).
...
Please update your merge request according to the [contributing guidelines](https://gitlab.com/gitlab-org/gitlab-foss/blob/master/doc/development/contributing/merge_request_workflow.md#merge-request-guidelines).
```
...
[issue tracker](https://gitlab.com/gitlab-org/gitlab-foss/issues) that is
